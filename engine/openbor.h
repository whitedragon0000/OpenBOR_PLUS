...
typedef enum
{
    SPAWN_ENTRY_PROP_AGGRESSION,
    SPAWN_ENTRY_PROP_ALIAS,
    SPAWN_ENTRY_PROP_ALPHA,
    SPAWN_ENTRY_PROP_AT,
    SPAWN_ENTRY_PROP_BLOCKADE,
    SPAWN_ENTRY_PROP_BOSS,
    SPAWN_ENTRY_PROP_COLOURMAP,
    SPAWN_ENTRY_PROP_CREDIT,
    SPAWN_ENTRY_PROP_DYING,
    SPAWN_ENTRY_PROP_DYING2,
    SPAWN_ENTRY_PROP_ENTITYTYPE,
    SPAWN_ENTRY_PROP_FLIP,
    SPAWN_ENTRY_PROP_GROUPMAX,
    SPAWN_ENTRY_PROP_GROUPMIN,
    SPAWN_ENTRY_PROP_HEALTH,
    SPAWN_ENTRY_PROP_INDEX,
    SPAWN_ENTRY_PROP_LIGHT,
    SPAWN_ENTRY_PROP_ITEM,
    SPAWN_ENTRY_PROP_ITEM_PROPERTIES,
    SPAWN_ENTRY_PROP_ITEMMODEL,
    SPAWN_ENTRY_PROP_MODEL,
    SPAWN_ENTRY_PROP_MP,
    SPAWN_ENTRY_PROP_MULTIPLE,
    SPAWN_ENTRY_PROP_MUSIC,
    SPAWN_ENTRY_PROP_MUSICFADE,
    SPAWN_ENTRY_PROP_MUSICOFFSET,
    SPAWN_ENTRY_PROP_NAME,
    SPAWN_ENTRY_PROP_NOJOIN,
    SPAWN_ENTRY_PROP_NOLIFE,
    SPAWN_ENTRY_PROP_PALETTE,
    SPAWN_ENTRY_PROP_PARENT,
    SPAWN_ENTRY_PROP_PER1,
    SPAWN_ENTRY_PROP_PER2,
    SPAWN_ENTRY_PROP_POSITION,
    SPAWN_ENTRY_PROP_SCORE,
    SPAWN_ENTRY_PROP_SCROLLMAXZ,
    SPAWN_ENTRY_PROP_SCROLLMINZ,
    SPAWN_ENTRY_PROP_SCROLLMAXX,
    SPAWN_ENTRY_PROP_SCROLLMINX,
    SPAWN_ENTRY_PROP_SHADOWALPHA,
    SPAWN_ENTRY_PROP_SHADOWCOLOR,
    SPAWN_ENTRY_PROP_SHADOWOPACITY,
    SPAWN_ENTRY_PROP_SPAWNPLAYER_COUNT,
    SPAWN_ENTRY_PROP_SPAWNTYPE,
    SPAWN_ENTRY_PROP_WAIT,
    SPAWN_ENTRY_PROP_WEAPON,
    SPAWN_ENTRY_PROP_WEAPONINDEX,
    SPAWN_ENTRY_PROP_WEAPONMODEL
} e_spawn_entry_properties;
