...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        ICMPCONST(BINDING_POSITIONING_NONE)
        ICMPCONST(BINDING_POSITIONING_TARGET)
        ICMPCONST(BINDING_POSITIONING_LEVEL)
        ...
        ICMPCONST(LEVEL_PROP_SPAWN_ENTRY)
        ICMPCONST(LEVEL_PROP_SPAWN_COUNT)
        ICMPCONST(LEVEL_PROP_SPAWN_PLAYER_POSITION)
        ...
        // Spawn Entry properties
        ICMPCONST(SPAWN_ENTRY_PROP_AGGRESSION)
        ICMPCONST(SPAWN_ENTRY_PROP_ALIAS)
        ICMPCONST(SPAWN_ENTRY_PROP_ALPHA)
        ICMPCONST(SPAWN_ENTRY_PROP_AT)
        ICMPCONST(SPAWN_ENTRY_PROP_BLOCKADE)
        ICMPCONST(SPAWN_ENTRY_PROP_BOSS)
        ICMPCONST(SPAWN_ENTRY_PROP_COLOURMAP)
        ICMPCONST(SPAWN_ENTRY_PROP_CREDIT)
        ICMPCONST(SPAWN_ENTRY_PROP_DYING)
        ICMPCONST(SPAWN_ENTRY_PROP_DYING2)
        ICMPCONST(SPAWN_ENTRY_PROP_ENTITYTYPE)
        ICMPCONST(SPAWN_ENTRY_PROP_FLIP)
        ICMPCONST(SPAWN_ENTRY_PROP_GROUPMAX)
        ICMPCONST(SPAWN_ENTRY_PROP_GROUPMIN)
        ICMPCONST(SPAWN_ENTRY_PROP_HEALTH)
        ICMPCONST(SPAWN_ENTRY_PROP_INDEX)
        ICMPCONST(SPAWN_ENTRY_PROP_LIGHT)
        ICMPCONST(SPAWN_ENTRY_PROP_ITEM)
        ICMPCONST(SPAWN_ENTRY_PROP_ITEM_PROPERTIES)
        ICMPCONST(SPAWN_ENTRY_PROP_ITEMMODEL)
        ICMPCONST(SPAWN_ENTRY_PROP_MODEL)
        ICMPCONST(SPAWN_ENTRY_PROP_MP)
        ICMPCONST(SPAWN_ENTRY_PROP_MULTIPLE)
        ICMPCONST(SPAWN_ENTRY_PROP_MUSIC)
        ICMPCONST(SPAWN_ENTRY_PROP_MUSICFADE)
        ICMPCONST(SPAWN_ENTRY_PROP_MUSICOFFSET)
        ICMPCONST(SPAWN_ENTRY_PROP_NAME)
        ICMPCONST(SPAWN_ENTRY_PROP_NOJOIN)
        ICMPCONST(SPAWN_ENTRY_PROP_NOLIFE)
        ICMPCONST(SPAWN_ENTRY_PROP_PALETTE)
        ICMPCONST(SPAWN_ENTRY_PROP_PARENT)
        ICMPCONST(SPAWN_ENTRY_PROP_PER1)
        ICMPCONST(SPAWN_ENTRY_PROP_PER2)
        ICMPCONST(SPAWN_ENTRY_PROP_POSITION)
        ICMPCONST(SPAWN_ENTRY_PROP_SCORE)
        ICMPCONST(SPAWN_ENTRY_PROP_SCROLLMAXZ)
        ICMPCONST(SPAWN_ENTRY_PROP_SCROLLMINZ)
        ICMPCONST(SPAWN_ENTRY_PROP_SCROLLMAXX)
        ICMPCONST(SPAWN_ENTRY_PROP_SCROLLMINX)
        ICMPCONST(SPAWN_ENTRY_PROP_SHADOWALPHA)
        ICMPCONST(SPAWN_ENTRY_PROP_SHADOWCOLOR)
        ICMPCONST(SPAWN_ENTRY_PROP_SHADOWOPACITY)
        ICMPCONST(SPAWN_ENTRY_PROP_SPAWNPLAYER_COUNT)
        ICMPCONST(SPAWN_ENTRY_PROP_SPAWNTYPE)
        ICMPCONST(SPAWN_ENTRY_PROP_WAIT)
        ICMPCONST(SPAWN_ENTRY_PROP_WEAPON)
        ICMPCONST(SPAWN_ENTRY_PROP_WEAPONINDEX)
        ICMPCONST(SPAWN_ENTRY_PROP_WEAPONMODEL)

        // Item properties
        ICMPCONST(ITEM_PROPERTIES_ALIAS)
        ICMPCONST(ITEM_PROPERTIES_ALPHA)
        ICMPCONST(ITEM_PROPERTIES_COLORSET)
        ICMPCONST(ITEM_PROPERTIES_HEALTH)
        ICMPCONST(ITEM_PROPERTIES_INDEX)
        ICMPCONST(ITEM_PROPERTIES_PLAYER_COUNT)
